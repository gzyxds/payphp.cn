        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Link
              ...
              className="hidden md:inline-flex items-center justify-center gap-2 rounded-full bg-[#015bfe] px-5 py-2 text-sm font-semibold text-white transition-all hover:bg-[#015bfe]/90 focus:outline-none focus:ring-2 focus:ring-[#015bfe] focus:ring-offset-2"
            >
