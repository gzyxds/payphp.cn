...
const FeaturesTab = () => {
  ...
  return (
    <>
      ...
      <section className="bg-gray-50/30 pb-20 pt-20 lg:pb-25 lg:pt-25 xl:pb-30 xl:pt-30">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          {/* 标题区域 - 简洁设计 */}
          <div className="mx-auto mb-16 max-w-4xl text-center">
            <div className="mb-4 inline-flex items-center rounded-lg bg-white px-4 py-2 text-sm font-medium text-[#165dff] border border-gray-200 shadow-sm">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="animate_top mb-16 xl:mb-20"
          >
            {/* Tab导航容器 - 现代简洁设计 */}
            <div className="mx-auto max-w-2xl">
              <div className="flex items-center justify-center rounded-xl bg-gray-100 p-1.5">
                {/* Tab 1 - 安全支付 */}
                <button
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="animate_top mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0"
          >
