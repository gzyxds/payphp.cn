    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-white to-slate-50 py-20 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-slate-100/40 rounded-full blur-3xl"></div>
          <svg className="absolute w-full h-full opacity-[0.03]" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="grid-pattern-hero" width="60" height="60" patternUnits="userSpaceOnUse">
                <path d="M 60 0 L 0 0 0 60" fill="none" stroke="currentColor" className="text-gray-500" strokeWidth="1"/>
              </pattern>
            </defs>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <div className="flex flex-wrap gap-2 mb-6">
                  <Badge variant="secondary" className="bg-blue-100 text-blue-700 hover:bg-blue-200 hover:scale-105 transition-transform duration-200">
                    聚合免签
                  </Badge>
                  <Badge variant="secondary" className="bg-blue-100 text-blue-700 hover:bg-blue-200 hover:scale-105 transition-transform duration-200">
                    高性能
                ...
                <p className="text-base lg:text-lg text-gray-500 leading-relaxed max-w-2xl">
              ...
              <div className="p-6 bg-white border border-gray-50 rounded-2xl">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3">
                  {paymentMethods.map((method) => (
                    <div key={method.id} className="p-3 sm:p-4 hover:bg-gray-50 transition-all duration-300 rounded-lg border border-gray-100 active:scale-[0.98]">
                ...
                <div className="mt-4 pt-4 border-t border-gray-100">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div className="group cursor-default">
                      <div className="text-base font-bold text-gray-800 group-hover:text-blue-600 transition-colors duration-200">99.9%</div>
                      <div className="text-xs text-gray-500">成功率</div>
                    </div>
                    <div className="group cursor-default">
                      <div className="text-base font-bold text-gray-800 group-hover:text-blue-600 transition-colors duration-200">&lt;1s</div>
                      <div className="text-xs text-gray-500">响应时间</div>
                    </div>
                    <div className="group cursor-default">
                      <div className="text-base font-bold text-gray-800 group-hover:text-blue-600 transition-colors duration-200">24/7</div>
        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature) => (
              <div
                key={feature.id}
                className="group bg-white border border-gray-100 rounded-xl p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
              >
                <div className="p-3 bg-blue-600 rounded-lg w-fit mb-4 group-hover:bg-blue-700 transition-colors">
            ...
            {scenarios.map((scenario, index) => (
              ...
              >
                <div className={`${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                  <div className="border border-gray-100 rounded-xl p-6 h-full flex flex-col justify-between">
                    <div>
                      <div className="flex items-center gap-2 mb-4">
                        <div className="p-1.5 bg-blue-50 rounded-md">
                          {scenario.icon}
                        </div>
                        <span className="text-sm text-blue-600 font-medium">{scenario.badge.label}</span>
                      </div>
                    ...
                    <Button variant="outline-primary" asChild className="w-fit">
                      <a href="/products">
                        了解更多
                ...
                <div className={`${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                  <div className="bg-white rounded-xl p-6 h-full flex flex-col justify-between">
                    <div>
                      <div className="flex items-center gap-2 mb-4">
                        {scenario.icon}
                        <span className="text-sm text-blue-600 font-medium">{scenario.badge.sub}</span>
                      </div>
                      
                      <h4 className="text-lg font-bold text-gray-900 mb-4">{scenario.title}</h4>
                    ...
                    <div className="mt-5 pt-4 border-t border-gray-100 space-y-2">
                      ...
                      <div className="flex items-center gap-2 pt-2 mt-2 border-t border-gray-50">
                        ...
                        <span className="text-xs text-gray-400">已服务 {scenario.status.users}</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {techAdvantages.map((advantage) => (
              <div
                key={advantage.id}
                className="bg-white border border-gray-100 rounded-xl p-6 text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
              >
        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {serviceGuarantees.map((guarantee, index) => (
              <div key={guarantee.id} className="bg-white border border-gray-100 rounded-xl p-6 flex items-center gap-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div className="p-3 bg-blue-50 rounded-lg flex-shrink-0">
                  {guarantee.icon}
                </div>
                <div className="flex-grow min-w-0">
                  <h3 className="text-lg font-bold text-gray-900 mb-2">{guarantee.title}</h3>
                  <p className="text-sm text-gray-500 leading-relaxed line-clamp-2">{guarantee.description}</p>
                </div>
                <ArrowRight className="w-5 h-5 text-gray-300 flex-shrink-0 group-hover:text-blue-500 transition-colors" />
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white rounded-2xl p-6 border border-gray-100 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
